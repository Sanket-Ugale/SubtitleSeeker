...
def home(request):
    ...
    #         # Appending the organized data to the list
    #         organized_data_list.append(organized_data)
    #     print(organized_data_list[0])
    #     # Printing the list of organized data
    #     # for organized_data in organized_data_list:
    #     #     print(organized_data)
    #     return render(request,'index.html',organized_data_list[0])
    # except:
    #     return render(request,'index.html')
